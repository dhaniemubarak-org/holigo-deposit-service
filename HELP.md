...
* The original package name 'id.holigo.services.holigo-deposit-service' is invalid and this project uses 'id.holigo.services.holigodepositservice' instead.
...
* [Spring for Apache ActiveMQ Artemis](https://docs.spring.io/spring-boot/docs/2.6.11/reference/htmlsingle/#messaging.jms.artemis)
